...
- [x] Create `scan_targets/npm/README.md` (expressjs/express)
- [x] Create `scan_targets/pnpm/README.md` (vitejs/vite)
- [x] Create `scan_targets/yarn/README.md` (facebook/jest)
...
- [x] Create `scan_targets/sbt/README.md` (scala/scala-parser-combinators)
- [x] Create `scan_targets/go/README.md` (cli/cli)
- [x] Create `scan_targets/cargo/README.md` (sharkdp/bat)
- [x] Create `scan_targets/nuget/README.md` (dotnet-architecture/eShopOnWeb)
- [x] Create `scan_targets/gemfile/README.md` (sinatra/sinatra)
- [x] Create `scan_targets/composer/README.md` (laravel/laravel)
- [x] Create `scan_targets/conan/README.md` (conan-io/examples)
- [x] Create `scan_targets/dart/README.md` (dart-lang/pub)
- [x] Create `scan_targets/bazel/README.md` (abseil/abseil-cpp)
- [x] Create `scan_targets/erlang/README.md` (ninenines/cowboy)
- [x] Create `scan_targets/ocaml/README.md` (mirage/mirage)
- [x] Create `scan_targets/perl/README.md` (libwww-perl/libwww-perl)
- [x] Create `scan_targets/r/README.md` (rstudio/shiny — note packrat.lock verification)
- [x] Create `scan_targets/bitbake/README.md` (documentation stub only)
